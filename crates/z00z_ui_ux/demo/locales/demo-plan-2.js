...
(() => {
  ...
  const english = Object.freeze({
    ...
    aria: {
      dappCatalogue: "Curated dApp catalogue",
      dappConnections: "dApp connections",
      dappPermissions: "dApp permissions",
      dappActivity: "dApp activity",
  ...
  const translations = Object.freeze({
    ru: {
      ...
      aria: { dappCatalogue: "Каталог отобранных dApps", dappConnections: "Подключения dApps", dappPermissions: "Разрешения dApps", dappActivity: "Активность dApps", localContacts: "Локальные контакты", watcherControls: "Детерминированные настройки Watchers", explorerControls: "Детерминированные настройки Explorer", explorerDetail: "Уровень сведений Explorer" }
    },
    fr: {
      ...
      aria: { dappCatalogue: "Catalogue dApps sélectionné", dappConnections: "Connexions dApps", dappPermissions: "Autorisations dApps", dappActivity: "Activité dApps", localContacts: "Contacts locaux", watcherControls: "Contrôles Watchers déterministes", explorerControls: "Contrôles Explorer déterministes", explorerDetail: "Niveau de détail Explorer" }
    },
    de: {
      ...
      aria: { dappCatalogue: "Ausgewählter dApp-Katalog", dappConnections: "dApp-Verbindungen", dappPermissions: "dApp-Berechtigungen", dappActivity: "dApp-Aktivität", localContacts: "Lokale Kontakte", watcherControls: "Deterministische Watchers-Steuerung", explorerControls: "Deterministische Explorer-Steuerung", explorerDetail: "Explorer-Detailstufe" }
    },
    es: {
      ...
      aria: { dappCatalogue: "Catálogo seleccionado de dApps", dappConnections: "Conexiones dApps", dappPermissions: "Permisos dApps", dappActivity: "Actividad dApps", localContacts: "Contactos locales", watcherControls: "Controles deterministas de Watchers", explorerControls: "Controles deterministas de Explorer", explorerDetail: "Nivel de detalle de Explorer" }
    },
    pt: {
      ...
      aria: { dappCatalogue: "Catálogo selecionado de dApps", dappConnections: "Ligações dApps", dappPermissions: "Permissões dApps", dappActivity: "Atividade dApps", localContacts: "Contactos locais", watcherControls: "Controlos determinísticos de Watchers", explorerControls: "Controlos determinísticos de Explorer", explorerDetail: "Nível de detalhe do Explorer" }
    },
    ko: {
      ...
      aria: { dappCatalogue: "선별된 dApp 카탈로그", dappConnections: "dApp 연결", dappPermissions: "dApp 권한", dappActivity: "dApp 활동", localContacts: "로컬 연락처", watcherControls: "결정론적 Watchers 제어", explorerControls: "결정론적 Explorer 제어", explorerDetail: "Explorer 세부 수준" }
    },
    tr: {
    ...
    ja: {
      ...
      aria: { dappCatalogue: "選定済み dApp カタログ", dappConnections: "dApp 接続", dappPermissions: "dApp 権限", dappActivity: "dApp アクティビティ", localContacts: "ローカル連絡先", watcherControls: "決定的 Watchers 操作", explorerControls: "決定的 Explorer 操作", explorerDetail: "Explorer 詳細レベル" }
    },
    "zh-Hans": {
      ...
      aria: { dappCatalogue: "精选 dApp 目录", dappConnections: "dApp 连接", dappPermissions: "dApp 权限", dappActivity: "dApp 活动", localContacts: "本地联系人", watcherControls: "确定性 Watchers 控件", explorerControls: "确定性 Explorer 控件", explorerDetail: "Explorer 详情级别" }
    }
  });
