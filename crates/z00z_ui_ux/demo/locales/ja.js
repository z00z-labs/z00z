...
window.Z00ZI18n.registerLocale("ja", {
  ...
  app: {
    documentTitle: "Z00Z Wallet", menu: "メニュー", wallets: "ウォレット", network: "ネットワーク",
    addWallet: "ウォレットを追加", removeWallet: "ウォレットを削除", settings: "設定", home: "ホーム",
    homeContext: "プライベートな資産をひと目で確認", settingsContext: "アプリケーション設定", walletContext: "{wallet} ウォレット", logOut: "ログアウト",
