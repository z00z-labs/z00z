...
(() => {
  ...
  const translations = {
    ru: {
      receive: { title: "Приватное получение", subtitle: "Активы, ваучеры и полномочия" },
      send: {
    ...
    de: {
      receive: { title: "Privat empfangen", subtitle: "Assets, Gutscheine und Berechtigungen" },
    ...
    fr: {
      receive: { title: "Recevoir en privé", subtitle: "Actifs, bons et permissions" },
    ...
    es: {
      receive: { title: "Recibir en privado", subtitle: "Activos, vales y permisos" },
    ...
    pt: {
      receive: { title: "Receber em privado", subtitle: "Ativos, vouchers e permissões" },
    ...
    tr: {
      receive: { title: "Özel al", subtitle: "Varlıklar, kuponlar ve izinler" },
    ...
    ja: {
      receive: { title: "非公開で受信", subtitle: "資産、バウチャー、権限" },
    ...
    ko: {
      receive: { title: "비공개로 받기", subtitle: "자산, 바우처 및 권한" },
    ...
    "zh-Hans": {
      receive: { title: "私密接收", subtitle: "资产、凭证与权限" },
