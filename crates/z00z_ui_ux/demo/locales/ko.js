...
window.Z00ZI18n.registerLocale("ko", {
  ...
  network: { routeTelemetry: "경로 텔레메트리", carrierTelemetry: "전송 텔레메트리", quicTelemetry: "QUIC 전송 텔레메트리", publicationTelemetry: "발행 텔레메트리" },
  walletShell: {
  ...
  quic: { title: "QUIC 텔레메트리", summary: "안전한 다중화 전송 세션, 스트림 및 경로 마이그레이션에 대한 읽기 전용 근거입니다.", localCapability: "로컬 QUIC 기능을 사용할 수 없음", localCapabilityHelp: "이 지갑 데모에는 등록된 QUIC 상태 브리지가 없습니다. 실제처럼 보이는 핸드셰이크, 스트림 또는 경로 데이터를 만들지 않습니다.", tabs: { overview: "개요", connections: "연결", paths: "경로", streams: "스트림", recovery: "복구", security: "보안" } },
  help: { title: "도움말", openGlobal: "애플리케이션 도움말 열기", openContext: "이 화면의 도움말", close: "도움말 닫기", contents: "목차", drawerTitle: "도움말 내용", onThisPage: "이 페이지", openOnThisPage: "이 페이지 목차 열기", closeOnThisPage: "이 페이지 목차 닫기", section: "도움말 섹션 {current}/{total}", unavailable: "이 화면의 도움말을 사용할 수 없습니다." },
