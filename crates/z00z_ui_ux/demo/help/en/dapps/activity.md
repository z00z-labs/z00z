...
id: dapps.activity
title: Activity
summary: Activity explains the bounded local dApps roadmap preview and its permission boundary.
scope: context
---
## Use this view {#current-view}
- Use Activity to inspect deterministic local descriptors, scoped intents, and explicit outcomes.
