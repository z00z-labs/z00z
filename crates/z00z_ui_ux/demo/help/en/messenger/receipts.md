...
title: Receipts
summary: Receipts explains the private request-coordination roadmap preview and its Wallet handoff.
scope: context
---
## Use this view {#current-view}
- Use Receipts to inspect deterministic local messages, requests, receipts, expiry, and recovery states.
