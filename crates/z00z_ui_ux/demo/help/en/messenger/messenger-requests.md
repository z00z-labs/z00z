...
title: Requests
summary: Requests explains the private request-coordination roadmap preview and its Wallet handoff.
scope: context
---
## Use this view {#current-view}
- Use Requests to inspect deterministic local messages, requests, receipts, expiry, and recovery states.
