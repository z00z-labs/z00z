---
id: dapps.donation
title: "dApps: Donation"
route: dapps.donation
scope: context
---
...
![dApps: Donation application view](help/assets/en/dapps-donation.png)
...
The dApp cannot debit the wallet and cannot attest how a beneficiary uses
funds. A prepared package is not proof of beneficiary receipt or settlement.

<!-- help-sync:source {"page_path":"dapps/donation.md","route_id":"dapps.donation","screenshot":"help/assets/en/dapps-donation.png","topic_id":"dapps.donation"} -->
