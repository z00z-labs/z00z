...
((root) => {
  ...
  const ASSET_ICON_LUT = deepFreeze({
    ...
    bcapNft: "assets/z00z-friendly/NFT/bcap-nft.svg",
    stableNft: "assets/z00z-friendly/NFT/stable-nft.svg"
  });
  ...
  const FRIENDLY_ASSET_CATALOG = deepFreeze([
    ...
    { key: "algorand", type: "coin", label: "Algorand", ticker: "ALGO", unit: "ALGO", iconSrc: ASSET_ICON_LUT.algorand, divisible: true, owner: "Algorand network", assetId: "external:algorand:algo" },
    { key: "avalanche", type: "coin", label: "Avalanche", ticker: "AVAX", unit: "AVAX", iconSrc: ASSET_ICON_LUT.avalanche, divisible: true, owner: "Avalanche network", assetId: "external:avalanche:avax" },
    { key: "bitcoin", type: "coin", label: "Bitcoin", ticker: "BTC", unit: "BTC", iconSrc: ASSET_ICON_LUT.bitcoin, divisible: true, owner: "Bitcoin network", assetId: "external:bitcoin:btc" },
    { key: "bold", type: "token", label: "BOLD", ticker: "BOLD", unit: "BOLD", iconSrc: ASSET_ICON_LUT.bold, divisible: true, owner: "Liquity protocol", assetId: "external:ethereum:bold" },
    { key: "cardano", type: "coin", label: "Cardano", ticker: "ADA", unit: "ADA", iconSrc: ASSET_ICON_LUT.cardano, divisible: true, owner: "Cardano network", assetId: "external:cardano:ada" },
    { key: "dai", type: "token", label: "Dai", ticker: "DAI", unit: "DAI", iconSrc: ASSET_ICON_LUT.dai, divisible: true, owner: "Sky protocol", assetId: "external:ethereum:dai" },
    { key: "ethereum", type: "coin", label: "Ethereum", ticker: "ETH", unit: "ETH", iconSrc: ASSET_ICON_LUT.ethereum, divisible: true, owner: "Ethereum network", assetId: "external:ethereum:eth" },
    { key: "hyperliquid", type: "coin", label: "Hyperliquid", ticker: "HYPE", unit: "HYPE", iconSrc: ASSET_ICON_LUT.hyperliquid, divisible: true, owner: "Hyperliquid network", assetId: "external:hyperliquid:hype" },
    { key: "liquity", type: "token", label: "Liquity", ticker: "LQTY", unit: "LQTY", iconSrc: ASSET_ICON_LUT.liquity, divisible: true, owner: "Liquity protocol", assetId: "external:ethereum:lqty" },
    { key: "solana", type: "coin", label: "Solana", ticker: "SOL", unit: "SOL", iconSrc: ASSET_ICON_LUT.solana, divisible: true, owner: "Solana network", assetId: "external:solana:sol" },
    { key: "zcash", type: "coin", label: "Zcash", ticker: "ZEC", unit: "ZEC", iconSrc: ASSET_ICON_LUT.zcash, divisible: true, owner: "Zcash network", assetId: "external:zcash:zec" },
