...
((root) => {
  ...
  const NAVIGATION_NODES = freeze([
    ...
    node({ id: "telemetry.aggregators", parentId: "telemetry", order: 30, labelKey: "navigation.aggregators", iconId: "staking", target: workspaceTarget("telemetry.aggregators.overview"), capabilityId: "telemetry.aggregators", helpTopicId: "telemetry.aggregators.overview" }),
