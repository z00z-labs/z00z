...
The historical companion audit is folded into this section. After this section exists, the historical audit artifact is no longer required as a separate source of truth.
...
Conflict resolutions preserved from the companion audit:
...
Residual risks retained from the companion audit:
