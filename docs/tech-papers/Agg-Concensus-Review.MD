# Aggregator Consensus Review

[TOC]



Status: architecture review and implementation roadmap  
Date: 2026-07-02  
Scope: local codebase only  
Canonical artifact: this review supersedes prior working notes  
...
### Do secondary aggregators also need to recalculate everything?
...
### What does Celestia publish today?
...
### What does aggregator consensus prove?
...
### Concrete live-code rename recommendation
...
### C4 Component View: Shard-Local Quorum Boundary
...
### Dynamic View: Required Full Simulation Path
...
### Lifecycle View: Secondary, Primary, Rotation, and Failure
...
### Promote to current implementation directives
...
### Keep external blockers out of current claims
...
## External and Deferred Target Appendix
...
### Dependency candidates and links
...
### External crate layout suggestion
...
### Networked BFT protocol pipeline retained
...
### BFT proposal validation checklist retained
...
### Backend, network, and storage suggestions retained
...
### External Celestia and settlement suggestions retained
...
### APIs, config, and metrics retained
...
### Tests, fuzzing, chaos, and runbooks retained
...
### Networked BFT implementation phases retained
...
### Networked BFT invariants and parameters retained
...
### External integration boundary retained
...
## Failure, Join, and Rotation Semantics

### Primary failure before commit
...
### Primary failure after local commit but before DA publication
...
## Required Full Simulation Harness
...
### Full local simulation code-dependency map
...
### Full local simulation flow contract
...
### Phase 0: Terminology and boundary cleanup
...
### Phase 1: Commit subject and certificate types
...
### Phase 2: Secondary replay verifier
...
### Phase 3: Local quorum certificate integration
...
### Phase 4: End-to-end `sim_5a7s` harness
...
### Phase 5: Join, removal, and rotation simulation
...
### Phase 6: Validator and theorem binding
...
### Phase 7: Network and signature adapter
...
### Phase 8: BFT and Celestia backend
...
## Practical Recommendation on Rotation
