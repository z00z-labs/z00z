...
| [Z00Z JMT Asset And Right Storage Design](tech-papers/Z00Z-HJMT-Design.md) | storage, semantic roots, canonical object paths | anchors this paper's object model to the live `SettlementStateRoot` / `SettlementPath` HJMT contract |
...
| How do storage paths and committed object roots fit together? | [Z00Z JMT Asset And Right Storage Design](tech-papers/Z00Z-HJMT-Design.md) |
