...
((root) => {
  ...
  const EXTENSION_ROUTE_IDS = freezeList([
    "extensions.discover",
    "extensions.pay",
    "extensions.request",
    ...
    "extensions.agents-budget",
    "extensions.wbold-gateway",
    "extensions.subscription",
    "extensions.donation",
    "extensions.escrow",
    "extensions.bounties",
    "extensions.tickets-passes",
    "extensions.service-credits",
    "extensions.digital-goods",
    "extensions.payroll",
    "extensions.private-contract",
    "extensions.assets-locker",
    "extensions.xchain-integration"
  ]);
  ...
  const PORT_CONTRACT = Object.freeze({
    ...
    extensionRoutes: EXTENSION_ROUTE_IDS,
