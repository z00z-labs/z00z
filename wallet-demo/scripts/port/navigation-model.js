...
((root) => {
  ...
  const CAPABILITY_PROFILES = freeze([
    ...
    profile({ id: "extensions", maturity: "concept", availability: "unavailable", evidenceSource: "fixture", freshness: "not_applicable", presentationMode: "roadmap_preview" }),
  ...
  const NAVIGATION_NODES = freeze([
    ...
    node({ id: "extensions", order: 30, labelKey: "navigation.extensions", iconId: "spark", target: branchTarget(), capabilityId: "extensions", presentationMode: "roadmap_preview", helpTopicId: "extensions.discover" }),
    node({ id: "extensions.agents-budget", parentId: "extensions", order: 10, labelKey: "navigation.agentsBudget", iconId: "extension-agents-budget", target: routeTarget("extensions.agents-budget"), capabilityId: "extensions", presentationMode: "roadmap_preview", helpTopicId: "extensions.agents-budget" }),
    node({ id: "extensions.assets-locker", parentId: "extensions", order: 20, labelKey: "navigation.assetsLocker", iconId: "extension-assets-locker", target: routeTarget("extensions.assets-locker"), capabilityId: "extensions", presentationMode: "roadmap_preview", helpTopicId: "extensions.assets-locker" }),
    node({ id: "extensions.bounties", parentId: "extensions", order: 30, labelKey: "navigation.bounties", iconId: "extension-bounties", target: routeTarget("extensions.bounties"), capabilityId: "extensions", presentationMode: "roadmap_preview", helpTopicId: "extensions.bounties" }),
    node({ id: "extensions.create-asset", parentId: "extensions", order: 40, labelKey: "navigation.createAsset", iconId: "assets", target: routeTarget("extensions.create-asset"), capabilityId: "extensions", presentationMode: "roadmap_preview", helpTopicId: "extensions.create-asset" }),
    node({ id: "extensions.create-permission", parentId: "extensions", order: 50, labelKey: "navigation.createPermission", iconId: "permission-list", target: routeTarget("extensions.create-permission"), capabilityId: "extensions", presentationMode: "roadmap_preview", helpTopicId: "extensions.create-permission" }),
    node({ id: "extensions.create-voucher", parentId: "extensions", order: 60, labelKey: "navigation.createVoucher", iconId: "voucher-list", target: routeTarget("extensions.create-voucher"), capabilityId: "extensions", presentationMode: "roadmap_preview", helpTopicId: "extensions.create-voucher" }),
    node({ id: "extensions.digital-goods", parentId: "extensions", order: 70, labelKey: "navigation.digitalGoods", iconId: "extension-digital-goods", target: routeTarget("extensions.digital-goods"), capabilityId: "extensions", presentationMode: "roadmap_preview", helpTopicId: "extensions.digital-goods" }),
    node({ id: "extensions.donation", parentId: "extensions", order: 80, labelKey: "navigation.donation", iconId: "extension-donation", target: routeTarget("extensions.donation"), capabilityId: "extensions", presentationMode: "roadmap_preview", helpTopicId: "extensions.donation" }),
    node({ id: "extensions.escrow", parentId: "extensions", order: 90, labelKey: "navigation.escrow", iconId: "extension-escrow", target: routeTarget("extensions.escrow"), capabilityId: "extensions", presentationMode: "roadmap_preview", helpTopicId: "extensions.escrow" }),
    node({ id: "extensions.pay", parentId: "extensions", order: 100, labelKey: "navigation.pay", iconId: "extension-pay", target: routeTarget("extensions.pay"), capabilityId: "extensions", presentationMode: "roadmap_preview", helpTopicId: "extensions.pay" }),
    node({ id: "extensions.payroll", parentId: "extensions", order: 110, labelKey: "navigation.payroll", iconId: "extension-payroll", target: routeTarget("extensions.payroll"), capabilityId: "extensions", presentationMode: "roadmap_preview", helpTopicId: "extensions.payroll" }),
    node({ id: "extensions.private-contract", parentId: "extensions", order: 120, labelKey: "navigation.privateContract", iconId: "extension-private-contract", target: routeTarget("extensions.private-contract"), capabilityId: "extensions", presentationMode: "roadmap_preview", helpTopicId: "extensions.private-contract" }),
    node({ id: "extensions.request", parentId: "extensions", order: 130, labelKey: "navigation.request", iconId: "extension-request", target: routeTarget("extensions.request"), capabilityId: "extensions", presentationMode: "roadmap_preview", helpTopicId: "extensions.request" }),
    node({ id: "extensions.service-credits", parentId: "extensions", order: 140, labelKey: "navigation.serviceCredits", iconId: "extension-service-credits", target: routeTarget("extensions.service-credits"), capabilityId: "extensions", presentationMode: "roadmap_preview", helpTopicId: "extensions.service-credits" }),
    node({ id: "extensions.subscription", parentId: "extensions", order: 150, labelKey: "navigation.subscription", iconId: "extension-subscription", target: routeTarget("extensions.subscription"), capabilityId: "extensions", presentationMode: "roadmap_preview", helpTopicId: "extensions.subscription" }),
    node({ id: "wallet.swap", parentId: "extensions", order: 160, labelKey: "navigation.swap", iconId: "swap", target: routeTarget("wallet.swap"), capabilityId: "wallet.swap", helpTopicId: "wallet.swap" }),
    node({ id: "extensions.tickets-passes", parentId: "extensions", order: 170, labelKey: "navigation.ticketsPasses", iconId: "extension-tickets-passes", target: routeTarget("extensions.tickets-passes"), capabilityId: "extensions", presentationMode: "roadmap_preview", helpTopicId: "extensions.tickets-passes" }),
    node({ id: "extensions.wbold-gateway", parentId: "extensions", order: 180, labelKey: "navigation.wboldGateway", iconId: "extension-wbold-gateway", target: routeTarget("extensions.wbold-gateway"), capabilityId: "extensions", presentationMode: "roadmap_preview", helpTopicId: "extensions.wbold-gateway" }),
    node({ id: "extensions.xchain-integration", parentId: "extensions", order: 190, labelKey: "navigation.xchainIntegration", iconId: "extension-xchain-integration", target: routeTarget("extensions.xchain-integration"), capabilityId: "extensions", presentationMode: "roadmap_preview", helpTopicId: "extensions.xchain-integration" }),
    node({ id: "extensions.discover", parentId: "extensions", order: 200, labelKey: "navigation.discover", iconId: "search", target: routeTarget("extensions.discover"), capabilityId: "extensions", presentationMode: "roadmap_preview", helpTopicId: "extensions.discover", sectionBreakBefore: true }),
