---
id: extensions.xchain-integration
title: "Extensions: X-Chain Integration"
route: extensions.xchain-integration
scope: context
---

# Extensions: X-Chain Integration

[TOC]

## App View {#current-view}

![Extensions: X-Chain Integration application view](help/assets/en/extensions-xchain-integration.png)
...
- Wallet selects inputs and verifies evidence; the Extension and solver do neither.
...
<!-- help-sync:source {"page_path":"extensions/xchain-integration.md","route_id":"extensions.xchain-integration","screenshot":"help/assets/en/extensions-xchain-integration.png","topic_id":"extensions.xchain-integration"} -->
