...
<!-- help-sync:source {"page_path":"settings/network/reticulum.md","route_id":"settings.reticulum","screenshot":"help/assets/en/settings-reticulum.png","topic_id":"settings.reticulum"} -->
