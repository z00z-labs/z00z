---
id: extensions.private-contract
title: "Extensions: Private Agreement"
route: extensions.private-contract
scope: context
---

# Extensions: Private Agreement

[TOC]

## App View {#current-view}

![Extensions: Private Agreement application view](help/assets/en/extensions-private-contract.png)
...
The Extension cannot bind either party, determine legal enforceability, interpret
...
<!-- help-sync:source {"page_path":"extensions/private-contract.md","route_id":"extensions.private-contract","screenshot":"help/assets/en/extensions-private-contract.png","topic_id":"extensions.private-contract"} -->
