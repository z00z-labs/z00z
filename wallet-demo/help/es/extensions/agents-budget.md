---
id: extensions.agents-budget
title: "Extensions: Agent Budget"
route: extensions.agents-budget
scope: context
---

# Extensions: Agent Budget

[TOC]

## App View {#current-view}

![Extensions: Agent Budget application view](help/assets/en/extensions-agents-budget.png)
...
<!-- help-sync:source {"page_path":"extensions/agents-budget.md","route_id":"extensions.agents-budget","screenshot":"help/assets/en/extensions-agents-budget.png","topic_id":"extensions.agents-budget"} -->
