...
window.Z00ZI18n.registerLocale("es", {
  ...
  app: {
    documentTitle: "Z00Z Wallet", menu: "Menú", wallets: "Carteras", network: "Red",
    addWallet: "Añadir cartera", removeWallet: "Eliminar cartera", settings: "Ajustes", home: "Inicio",
    homeContext: "Tu dinero privado de un vistazo", settingsContext: "Preferencias de la aplicación", walletContext: "Cartera {wallet}", logOut: "Cerrar sesión",
    ...
    currency: "Moneda", currencyHelp: "Moneda utilizada para mostrar el valor de las monedas",
