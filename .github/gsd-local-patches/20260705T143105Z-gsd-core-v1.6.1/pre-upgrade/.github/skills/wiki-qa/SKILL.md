...
- **Include at least 1 Mermaid diagram** when the answer involves architecture, data flow, or relationships — use the `mermaid-spectrum` semantic palette when Mermaid is included
