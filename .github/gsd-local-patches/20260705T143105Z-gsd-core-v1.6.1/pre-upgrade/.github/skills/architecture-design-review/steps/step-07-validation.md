...
- When 'P' selected: Run an inline multi-perspective review of the validation issues
...
- Run an inline advanced elicitation round with the validation issues
...
- Run an inline multi-perspective review with the validation context
