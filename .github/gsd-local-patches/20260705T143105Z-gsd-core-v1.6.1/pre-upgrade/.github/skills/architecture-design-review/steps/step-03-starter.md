...
- When 'P' selected: Run an inline multi-perspective review of the starter options
...
- Run an inline advanced elicitation round with the current starter analysis
...
- Run an inline multi-perspective review with the starter evaluation context
