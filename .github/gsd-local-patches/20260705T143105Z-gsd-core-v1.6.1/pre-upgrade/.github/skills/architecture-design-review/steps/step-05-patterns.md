...
- When 'P' selected: Run an inline multi-perspective review of the implementation patterns
...
- Run an inline advanced elicitation round with the current patterns
...
- Run an inline multi-perspective review with the implementation patterns context
