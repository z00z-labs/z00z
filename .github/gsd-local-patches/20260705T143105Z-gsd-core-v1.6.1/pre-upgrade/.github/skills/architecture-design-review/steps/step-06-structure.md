...
- When 'P' selected: Run an inline multi-perspective review of the project structure
...
- Run an inline advanced elicitation round with the current project structure
...
- Run an inline multi-perspective review with the project structure context
