...
- When 'P' selected: Run an inline multi-perspective review of the current decisions
...
- Run an inline advanced elicitation round on the specific decision categories
...
- Run an inline multi-perspective review with the architectural decisions context
