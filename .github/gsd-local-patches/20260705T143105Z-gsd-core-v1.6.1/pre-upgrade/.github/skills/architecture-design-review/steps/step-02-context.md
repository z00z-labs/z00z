...
- When 'A' selected: Run an inline advanced elicitation round with the user
- When 'P' selected: Run an inline multi-perspective review of the current architecture context
...
- Run an inline advanced elicitation round using the current context analysis
...
- Run an inline multi-perspective review using the current project context
