...
- When 'P' selected: Run an inline multi-perspective review of the current category rules
...
- Run an inline advanced elicitation round with the current category rules
...
- Run an inline multi-perspective review with the category rules context
