...
## Overview
Generated VitePress documentation site. Contains architecture docs, onboarding guides, and API references with source-linked citations and Mermaid diagrams that use the `mermaid-spectrum` semantic palette.
