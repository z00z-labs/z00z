...
Show this to the user, then immediately proceed to Step 2. The user reads and thinks while the independent design passes run.

### 2. Generate alternatives

Generate 3+ radically different interface designs. Use parallel workers, independent reviewers, or separate reasoning passes when the current environment supports them; otherwise produce the alternatives yourself in clearly separated passes.
...
Include both [LANGUAGE.md](LANGUAGE.md) vocabulary and existing project glossary vocabulary in the brief so each alternative names things consistently with the architecture language and the project's domain language.
