...
- Include Mermaid diagrams that use the `mermaid-spectrum` semantic palette when they clarify architecture or flow — add `<!-- Sources: ... -->` comment block after each diagram
